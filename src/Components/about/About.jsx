        ...
        <div className='About-contaienr'>
            ...
            <div className="about-right">
                ...
                <p className='about-desc'>
                    เนื่องจากตอนนี้ผมได้ศึกษาและพัฒนาระบบในส่วนของ Front-end โดยใช้ React เป็นระยะเวลา 1 เดือน ซึ่งผมเองสนใจในส่วนของการทำงานของระบบหน้าบ้านเป็นอย่างมาก โดยผมต้องการศึกษาและพัฒนาทักษะในส่วนของระบบหน้าบ้านเพิ่มเติมและนำความรู้ที่ได้เรียนรู้มาพัฒนาฝึมือในการทำงานของตนเอง ณ ปัจจุบันให้ดียิ่งขึ้นรวมไปถึงในอนาคต
                </p>
